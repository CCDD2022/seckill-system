...
const file_proto_seckill_proto_rawDesc = "" +
	"\n" +
	"\x13proto/seckill.proto\x12\aseckill\"d\n" +
	...
	"\border_id\x18\x03 \x01(\x03R\aorderId2U\n" +
	"\x0eSeckillService\x12C\n" +
	"\x0eExecuteSeckill\x12\x17.seckill.SeckillRequest\x1a\x18.seckill.SeckillResponseB\x16Z\x14proto_output/seckillb\x06proto3"
